...
-- Stores user management data (name, DOB, address)
-- ============================================
...
CREATE INDEX idx_user_management_name ON user_management(name);
CREATE INDEX idx_user_management_created_at ON user_management(created_at);
...
-- Grant permissions for user management table
